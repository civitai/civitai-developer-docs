...
- [Background removal](./image-background-removal) — isolate the subject on a transparent canvas using BiRefNet; PNG or WebP output; ~6–13 Buzz (scales mildly with resolution)
