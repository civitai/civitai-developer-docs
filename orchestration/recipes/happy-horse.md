...
const t2vBody = {
  steps: [{
    $type: 'videoGen',
    input: {
      engine: 'happyHorse', version: 'v1.1', operation: 'textToVideo',
...
const i2vBody = {
  steps: [{
    $type: 'videoGen',
    input: {
      engine: 'happyHorse', version: 'v1.1', operation: 'imageToVideo',
...
const refBody = {
  steps: [{
    $type: 'videoGen',
    input: {
      engine: 'happyHorse', version: 'v1.1', operation: 'referenceToVideo',
